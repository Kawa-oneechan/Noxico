...
cd bin\Release
..\..\7za.exe a ..\noxico-0.1.8.7z fonts fmodex64.dll Noxico.exe
..\..\Rar.exe u ..\noxico-0.1.8.rar fonts fmodex64.dll Noxico.exe
..\..\Rar.exe u ..\noxico-music.rar music sounds
cd ..\Release32
..\..\7za.exe a ..\noxico-0.1.8-32.7z fonts fmodex.dll Noxico.exe
..\..\Rar.exe u ..\noxico-0.1.8-32.rar fonts fmodex.dll Noxico.exe
pause
