...
namespace Noxico
{
	...
	public class Character : TokenCarrier
	{
		...
		{
			/*
Warning, Certainty 95, for AvoidExcessiveLocals
{
    Target       : #LookAt(Noxico.Entity)  (IntrospectionTargetMember)
    Location     : file:///C:/hg/noxico/Character.cs  (String)
    Resolution   : "'Character.LookAt(Entity)' has 76 local variables, 
                   5 of which were generated by the compiler. Refactor 
                   'Character.LookAt(Entity)' so that it uses fewer than 
                   64 local variables."
    Help         : http://msdn.microsoft.com/library/ms182263(VS.100).aspx  (String)
    Category     : Microsoft.Performance  (String)
    CheckId      : CA1809  (String)
    RuleFile     : Performance Rules  (String)
    Info         : "Method implementations should not contain more than 
                   64 local variables. In order for the run-time to enregister 
                   local variables most efficiently, there should be 64 
                   or fewer of them. Enregistering based on flow analysis 
                   will not occur for locals in excess of 64, which may 
                   result in slower performance."
    Created      : 11-2-2013 22:03:19  (DateTime)
    LastSeen     : 11-2-2013 22:04:15  (DateTime)
